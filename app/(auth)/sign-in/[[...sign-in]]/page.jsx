        ...
        <main className="flex items-center justify-center px-4 py-8 sm:px-8 sm:py-12 md:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
          <div className="max-w-lg sm:max-w-xl md:max-w-2xl lg:max-w-3xl">
            <div className="relative block lg:hidden">
              <a
                className="inline-flex items-center justify-center h-16 w-16 sm:h-20 sm:w-20 rounded-full bg-white text-blue-600"
                href="#"
              >
                <span className="sr-only">Home</span>
                <svg
              ...
              <h1 className="mt-2 text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">
                Welcome to Farm To Fork !
              </h1>

              <p className="mt-4 mb-4 text-gray-500 leading-relaxed">
