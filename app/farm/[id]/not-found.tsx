      ...
      <div className="text-center space-y-8 max-w-2xl mx-auto">
        ...
        <div className="space-y-4">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            Il semblerait que cette ferme n'existe plus, n'est pas encore
            publiée, ou que le lien que vous avez suivi soit obsolète.
          </p>

          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 text-amber-800">
            <p className="text-sm">
              <strong>💡 Le saviez-vous ?</strong> Les producteurs peuvent
              temporairement désactiver leurs listings pour mise à jour ou en
              cas d'indisponibilité saisonnière.
            </p>
          </div>
        </div>
        ...
        {autoRedirect && countdown > 0 && (
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 space-y-3">
            <p className="text-blue-800 text-sm">
              <strong>Redirection automatique</strong> vers l'exploration des
              fermes dans{" "}
