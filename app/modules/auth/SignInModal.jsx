          ...
          <SignIn
            ...
            appearance={{
              elements: {
                ...
                header: "pb-0",
                footer: "mt-4",
                // Ajout de padding aux éléments internes
                rootBox: "px-0", // Padding horizontal pour tout le conteneur
                formFieldLabel: "mt-4", // Un peu plus d'espace au-dessus des labels
                socialButtonsBlockButton: "my-1", // Espace vertical entre boutons sociaux
                formFieldAction: "mt-1", // Espace pour les liens d'action
                // Ajouter des marges au conteneur principal
                form: "px-6",
                // Ajouter des marges autour du titre et des descriptions
                headerTitle: "mt-6 mb-4",
                headerSubtitle: "mb-8",
              },
              variables: {
                colorPrimary: "#16a34a",
                borderRadius: "0.375rem",
                // Vous pouvez également ajuster l'espacement global
                spacingUnit: "6px", // Unité de base pour l'espacement
              },
            }}
          />
        </main>
