// app/discover/producteurs/page.tsx
"use client";
...
/**
 * Page éditoriale des producteurs partenaires
 * Route: /discover/producteurs
 *
 * Features:
    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      >
        ...
        <div className="flex justify-center mb-8">
          ...
          >
            <p className="text-center" style={{ color: COLORS.TEXT_SECONDARY }}>
              🚜 <strong>Annuaire en construction</strong>
              <br />
              La liste détaillée des producteurs arrive bientôt !
              <br />
              <span className="text-sm">
                Explorez dès maintenant la carte interactive pour découvrir nos
